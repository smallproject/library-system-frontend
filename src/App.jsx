                        ...
                        <main className="col-12">
                            <Routes>
                                ...
                                <Route path="/api/v1/books"
                                       element={<ProtectedRoute element={<BookOverviewPage/>}
                                                                isAuthenticated={isAuth}/>}/>
                                <Route path="/api/v1/books/create"
                                       element={<ProtectedRoute element={<BookCardCreatePage/>}
                                                                isAuthenticated={isAuth}/>}/>
                                ...
                                <Route path={"/api/v1/users"}
                                       element={<ProtectedRoute element={<UserOverviewPage/>}
                                                                isAuthenticated={isAuth}/>}/>
                                <Route path="/api/v1/users/:id"
                                       element={<ProtectedRoute element={<UserCardViewPage/>}
                                                                isAuthenticated={isAuth}/>}/>
